...
// Time Limit: 1000
// Start: Wed Jul 30 20:43:39 2025
// mintemplate
#ifdef MISAKA
...
void shiina_mashiro() {
    ...
    auto f0 = binpow(mint(2), (ll)n * n);
    auto f90 = binpow(mint(2), ((ll)n * n + 3) / 4);
    auto f180 = binpow(mint(2), ((ll)n * n + 1) / 2);
    cout << ((f0 + f90 + f90 + f180) / 4).v << nl;
}
